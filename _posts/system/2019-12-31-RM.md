...
![resource plan](/media/oracle-resource-plan.gif)
...
![resource subplan](/media/oracle-resource-subplan.gif)
...
![resource governor](/media/sql-server-resource-governor.gif)
...
![resource pool](/media/sql-server-resource-pool.png)
...
![resource queue](/media/greenplum-resource-queue.jpg)
...
![resource queue example](/media/greenplum-resource-queue-example.png)
